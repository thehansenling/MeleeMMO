...
class NeutralSpecialPlayerState : PlayerState
{
    public override string name_ { get { return "NEUTRAL_SPECIAL"; } }
    public override int duration_frames_ { get { return 20; } }
    private bool fast_fall = false;
    public NeutralSpecialPlayerState(Character player) : base(player)
    {
        player.animator_.SetInteger("state", (int)CharacterState.NeutralSpecial);
    }
