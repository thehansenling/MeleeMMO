...
class UpSpecialPlayerState : PlayerState
{
    public override string name_ { get { return "UP_SPECIAL"; } }
    public override int duration_frames_ { get { return 20; } }
    private bool fast_fall = false;
    public UpSpecialPlayerState(Character player) : base(player)
    {
        player.animator_.SetInteger("state", (int)CharacterState.UpSpecial);
    }
